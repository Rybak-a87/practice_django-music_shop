...
import musicshop.utils.uploading
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=musicshop.utils.uploading.upload_function)),
            ],
            options={
                'verbose_name': 'Альбом',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField()),
                ('image', models.ImageField(blank=True, null=True, upload_to=musicshop.utils.uploading.upload_function)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=20, verbose_name='Телефон')),
                ('address', models.CharField(blank=True, max_length=500, verbose_name='Адрес')),
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ получен покупателем'), ('canceled', 'Заказ отменен')], default='new', max_length=50, verbose_name='Статус заказа')),
                ('buying_type', models.CharField(choices=[('self', 'Самовывоз'), ('delivery', 'Доставка')], max_length=50, verbose_name='Тип заказа')),
                ('comment', models.TextField(blank=True, verbose_name='Коментарий к заказу')),
                ('created_at', models.DateField(auto_now=True, verbose_name='Дата создани заказа')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='related_customer', to='main.Order', verbose_name='Заказы'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
        ...
        migrations.AddField(
            model_name='customer',
            name='wishlist',
            field=models.ManyToManyField(blank=True, to='main.Album', verbose_name='Список ожидаемого'),
        ),
        migrations.CreateModel(
            name='CartProduct',
            fields=[
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, null=True, related_name='related_card', to='main.CartProduct', verbose_name='Продукты для корзины'),
        ),
        migrations.CreateModel(
            name='Artist',
            fields=[
        ...
        migrations.AddField(
            model_name='album',
            name='media_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.mediatype', verbose_name='Медианоситель'),
        ),
    ]
